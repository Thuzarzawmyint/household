...
<?php
    ...
    if(!$myrow){
        ...
        print"<form name='editform' action='APEdit2.php' method='post'   enctype='multipart/form-data'>
        <table class='tablee'>
        <tr><td>Product ID</td>
        <td>$productid<input type='hidden' name='aproductid' value='$productid'></td>
        </tr>
        <tr><td>Category</td>
        <td><input type='text' name='cname' value='$category'></td></tr>
        <tr><td>Productname</td><td><input type='text' name='pdtname' value='$pname'></td></tr>
        <tr><td>Price</td><td><input type='text' name='sprice' value='$price'></td></tr>
