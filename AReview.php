...
.proheader {
    ...
    text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.5);
        ...
        .tablee th {
            background-color: #3e6b5b; /* Purple header */
            color: white;
        ...
        .tablee tr:hover {
            background-color: #f08080; /* Light blue on hover */
        }
...
<div class="entries">
    <center>
        ...
        if($result){
            ...
            print "<th>Review Id<th>Customer<th>Email<th>Product Name<th>Comment<th>Date";
            while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
            {
                $ridd = $row['Id'];
                $rcustomer = $row['customer'];
                $remail = $row['email'];
                $rpname = $row['productname'];
                ...
                print "<td>".$ridd."</td>";
                print "<td>".$rcustomer."</td>";
                print "<td style='text-align: center;'>".$remail."</td>";
                print "<td>".$rpname."</td>";
                print "<td>".$rcomment."</td>";
                print "<td>".$rdate."</td>";
