...
<div class="entries">
    <h1 class="proheader">Edit Form</h1>

        </br>
<form name="editform" action ="APEdit1.php" method="post" enctype = 'multipart/form-data'>
    <center>
    ...
    <tr>
        <th>Product ID : </th>
        <td><input type="text" name="aproductid" size="30"></td>
        </center>
    </tr>
