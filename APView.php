        ...
        <div class="entries">
            <center>
                ...
                if ($result) {
                    ...
                    print "<th>Product ID</th><th>Category</th><th>Name</th><th>Price</th><th>Photo</th>";
                    ...
                    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                        ...
                        print "<td>" . $pid . "</td>";
                        print "<td>" . $pcat . "</td>";
                        print "<td style='text-align: center;'>" . $pname . "</td>";
                        print "<td>$" . $price . "</td>";
                        print "<td><img src='data:image/png;base64," . base64_encode($photo) . "' alt='Image' ></td>"; 
                        print "</tr>";
                    }
                    print "</table>";
                } else {
