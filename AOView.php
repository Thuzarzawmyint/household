...
<div class="entries">
    <center>
        ...
        if($result){
            ...
            print "<th>Order ID<th>Customer Name</th><th>Address</th><th>Quantity<th>Phone Number";
            while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
            {
                $oid = $row['Id'];
                $ocname = $row['customer_name'];
                ...
                print "<td>".$oid."</td>";
                print "<td>".$ocname."</td>";
                print "<td style='text-align: center;'>".$oaddress."</td>";
               /* print "<td>".$opid."</td>";*/
                print "<td>".$oquantity."</td>";
                print "<td>".$ophno."</td>";
